...
import { Mail, Lock, Eye, EyeOff, Landmark, ArrowRight } from "lucide-react";
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-100">
          ...
          <p className="text-sm text-gray-400 text-center mt-1.5">
            {t("auth.login.subtitle") || "Sign in to continue your journey"}
          </p>
          ...
          <form className="mt-7 space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-lg text-sm text-gray-700 placeholder-gray-300 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/20 transition"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-0.5">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-200 text-primary focus:ring-primary/20" />
                <span className="text-sm text-gray-500">{t("auth.login.rememberMe")}</span>
              </label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 py-2.5 border border-gray-200 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition">
