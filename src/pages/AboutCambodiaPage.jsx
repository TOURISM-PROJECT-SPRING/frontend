...
export default function AboutCambodiaPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <section className="py-10 sm:py-14 lg:py-16 xl:py-20">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16 items-start">
            ...
            {/* Right: History */}
            <div>
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white tracking-tight mb-3 sm:mb-4">
                {t("aboutCambodia.history.title")}
              </h3>
              <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400 leading-relaxed mb-5 sm:mb-6">
              ...
              <div className="space-y-3">
                {historyCards.map((card) => (
                  <div
                    key={card.title}
                    className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-gray-900 rounded-xl hover:bg-primary/5 transition-colors cursor-pointer group"
                  >
                    <img
                      src={card.image}
                      alt={card.title}
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-gray-400 dark:text-gray-500">{card.century}</p>
                    </div>
      ...
      {/* ─── Explore Categories ─── */}
      <section className="py-10 sm:py-14 lg:py-16 bg-gray-50/80 dark:bg-gray-900">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 items-center">
            ...
            <div className="lg:col-span-3">
              ...
              <p className="mt-2.5 sm:mt-3 text-sm sm:text-base text-gray-500 dark:text-gray-400 leading-relaxed">
            ...
            <div className="lg:col-span-4 space-y-2.5 sm:space-y-3">
              {regions.map(({ key, icon: Icon }) => (
                <a
                  key={key}
                  href="#"
                  className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 hover:border-primary/30 hover:shadow-md hover:shadow-primary/5 transition-all group"
                >
      ...
      {/* ─── Trust Bar ─── */}
      <section className="py-10 sm:py-14 bg-gray-50/80 dark:bg-gray-900">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white tracking-tight text-center mb-7 sm:mb-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 lg:gap-5">
            {trustReasons.map(({ key, icon: Icon }) => (
              <div
                key={key}
                className="flex flex-col items-center text-center p-4 sm:p-5 bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 hover:shadow-lg hover:shadow-gray-200/50 dark:hover:shadow-none transition-all"
              >
        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
            ...
            <div className="lg:col-span-4">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white tracking-tight mb-4 sm:mb-5">
                {t("aboutCambodia.tips.title")}
              </h2>
              <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-4 sm:p-5 space-y-3 sm:space-y-4">
                {[
            ...
            <div className="lg:col-span-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {featuredExperiences.map((exp) => (
                  <article
                    key={exp.title}
                    className="flex gap-4 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 p-3 hover:shadow-lg hover:shadow-gray-200/50 dark:hover:shadow-none transition-all cursor-pointer group"
                  >
                    <img
                      src={exp.image}
                      alt={exp.title}
