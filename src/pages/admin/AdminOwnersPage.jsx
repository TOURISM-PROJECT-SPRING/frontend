...
export default function AdminOwnersPage() {
  ...
  const handleQuickVerify = async (item, newStatus) => {
    ...
    toast.success(`Owner ${newStatus === "VERIFIED" ? "verified" : "marked pending"} successfully`);
  };
  ...
  if (loading) return <AdminLoading message="Loading businesses from the server..." />;
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <TotalBadge count={owners.length} />
          </div>
