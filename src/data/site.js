...
export const dashboardNav = [
  ...
  { label: "Explore Tours", icon: "compass" },
...
export const quickActions = [
  { title: "Explore Tours", subtitle: "Find your next adventure", icon: "compass", image: img("Bayon temple 02.jpg", 600) },
  { title: "Find Hotels", subtitle: "Book your perfect stay", icon: "bed", image: img("Palm Paradise Pool.jpg", 600) },
  { title: "Discover Restaurants", subtitle: "Taste something new", icon: "utensils", image: img("Fish Amok.jpg", 600) },
];

export const dashboardStats = [
  { label: "Upcoming Trips", value: 3, icon: "luggage", tone: "green" },
  { label: "Hotel Bookings", value: 2, icon: "bed", tone: "gold" },
  { label: "Restaurant Orders", value: 1, icon: "utensils", tone: "green" },
  { label: "Saved Places", value: 8, icon: "heart", tone: "gold" },
];
...
export const bookings = [
  {
    ...
    status: "Confirmed",
    type: "Tours",
    image: img("Angkor Wat, reflejo 2.jpg", 400),
  },
  {
    name: "Angkor Paradise Hotel",
    location: "Siem Reap",
    date: "Apr 18 – Apr 20, 2025",
    status: "Confirmed",
    type: "Hotels",
    image: img("Palm Paradise Pool.jpg", 400),
  },
  {
    name: "Khmer Garden Restaurant",
    location: "Phnom Penh",
    date: "Apr 22, 2025",
    status: "Pending",
    type: "Restaurants",
    image: img("Fish Amok.jpg", 400),
  },
];

export const recommended = [
  { kind: "Tours", name: "Angkor Wat Temple Tour", meta: "Siem Reap • 1 Day • $45", rating: 4.9, image: img("Bayon temple 02.jpg", 600) },
  { kind: "Hotels", name: "The Royal Sands Hotel", meta: "Sihanoukville • $120/night", rating: 4.8, image: img("Swimming pool and Makuti-thatched villa in Malindi.jpg", 600) },
  { kind: "Restaurants", name: "Romdeng Restaurant", meta: "Phnom Penh • $$", rating: 4.7, image: img("Beef Lok Lak.jpg", 600) },
];

export const favorites = [
  { kind: "Tours", name: "Angkor Wat Tour", meta: "Siem Reap", image: img("Angkor_Wat.jpg", 500) },
  { kind: "Hotels", name: "Sokha Beach Resort", meta: "Sihanoukville", image: img("Negombo Beach resort pool (Unsplash).jpg", 500) },
  { kind: "Restaurants", name: "Khmer Kitchen", meta: "Phnom Penh", image: img("Fish Amok.jpg", 500) },
  { kind: "Tours", name: "Koh Rong Island", meta: "Sihanoukville", image: img("Koh_Rong_island.jpg", 500) },
];
