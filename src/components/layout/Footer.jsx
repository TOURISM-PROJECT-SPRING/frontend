          ...
          <div className="col-span-2 sm:col-span-2 lg:col-span-2">
            ...
            <div className="space-y-2 sm:space-y-2.5 text-xs sm:text-sm">
              ...
              <div className="flex items-center gap-2 sm:gap-2.5">
                ...
                <span className="truncate">info@smarttourismcambodia.com</span>
              </div>
            </div>
          </div>

          {linkSections.map(({ titleKey, links }) => (
            <div key={titleKey}>
        ...
        <div className="mx-auto w-full max-w-screen-2xl px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
            <p className="text-[10px] sm:text-xs text-gray-500 text-center sm:text-left">
              &copy; {new Date().getFullYear()} Smart Tourism Cambodia. {t("footer.copyright")}
            </p>
