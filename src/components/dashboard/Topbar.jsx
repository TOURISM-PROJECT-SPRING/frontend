...
export default function Topbar() {
  ...
  const { user, logout, switchTestAccount } = useAuth();
  const {
    activeCount,
    lockedCount,
    statusSummary,
    ...
    <header className="h-16 bg-white dark:bg-gray-950 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between px-6 shrink-0 animate-slide-down relative z-30">
      ...
      <div className="flex items-center gap-2 ml-4 shrink-0">
        ...
        <div className="relative">
          ...
          >
            <div className="w-8 h-8 bg-[#1b3b2b] border border-[#2d6a4f]/40 rounded-full flex items-center justify-center shadow-xs">
