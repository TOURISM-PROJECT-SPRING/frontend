...
export default function SmartImage({ src, alt = "", className = "", imgClassName = "", ratio }) {
  ...
  return (
    <div className={`relative overflow-hidden bg-brand-100 ${className}`} style={ratio ? { aspectRatio: ratio } : undefined}>
      ...
      {showFallback && (
        <div className="grid h-full w-full place-items-center bg-gradient-to-br from-brand-700 to-brand-500">
