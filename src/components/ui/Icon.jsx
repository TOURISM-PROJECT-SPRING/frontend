// Self-contained inline-SVG icon set (lucide-style line icons, currentColor).
// Avoids any icon-library version risk and keeps a single consistent system.
...
const PATHS = {
  ...
  binoculars: <><path d="M10 10h4" /><path d="M19 7V4a1 1 0 0 0-1-1h-2a1 1 0 0 0-1 1v3" /><path d="M20 21a2 2 0 0 0 2-2v-3.851c0-1.39-2-2.962-2-4.829V8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v11a2 2 0 0 0 2 2z" /><path d="M22 16H2" /><path d="M4 21a2 2 0 0 1-2-2v-3.851c0-1.39 2-2.962 2-4.829V8a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v11a2 2 0 0 1-2 2z" /><path d="M9 7V4a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1v3" /></>,
  ...
  ticket: <><path d="M3 9a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2 2 2 0 0 0 0 4 2 2 0 0 1-2 2H5a2 2 0 0 1-2-2 2 2 0 0 0 0-4Z" /><line x1="13" y1="7" x2="13" y2="17" /></>,
  luggage: <><rect x="6" y="8" width="12" height="13" rx="2" /><path d="M9 8V6a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2" /><path d="M9 21v1M15 21v1" /><path d="M10 12v5M14 12v5" /></>,
  ...
  // ---- Hotels listing page (path data copied from lucide-react v1.34) ----
  "calendar-days": (
    <>
      <path d="M8 2v3" />
      <path d="M16 2v3" />
