  ...
  return (
    <div className="relative">
      <button
        ...
        aria-expanded={open}
        className="p-2 rounded-xl hover:bg-[#edf5f0] dark:hover:bg-gray-800 transition cursor-pointer"
      >
        <ActiveIcon
          className={`w-5 h-5 ${
            isDark
              ? "text-amber-400"
              : "text-[#1b3b2b] dark:text-gray-300"
          }`}
        />
      </button>
            ...
            {OPTIONS.map((option) => {
              ...
              return (
                <button
                  ...
                  className={`flex w-full items-center gap-2.5 px-3 py-2 text-sm transition cursor-pointer ${
                    active
                      ? "text-[#1b3b2b] dark:text-emerald-300 bg-[#edf5f0] dark:bg-[#16291e] font-semibold"
                ...
                >
                  ...
                  {active && (
                    <Check className="w-3.5 h-3.5 ml-auto text-[#1b3b2b] dark:text-emerald-300" />
                  )}
                </button>
              );
            })}
