  ...
  return (
    <section id="destinations" className="bg-cream py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow={t("destinations.eyebrow") || "Destinations"}
          title={t("destinations.title") || "Popular Destinations"}
          action={
            <Link to="/destinations" className="group hidden items-center gap-1.5 text-sm font-bold text-brand-700 sm:inline-flex">
              {t("destinations.viewAll") || "View All"} <Icon name="arrow-right" size={16} className="transition-transform duration-500 ease-out group-hover:translate-x-1" />
            </Link>
          }
        />
