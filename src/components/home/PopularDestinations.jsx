            ...
            {popularDestinations.map((dest) => (
              ...
              >
                ...
                <div className="p-3 sm:p-4">
                  <h3 className="font-semibold text-sm sm:text-base text-gray-900 dark:text-white">{dest.title}</h3>
                  <p className="text-[10px] sm:text-xs text-gray-400 dark:text-gray-500 mt-0.5">{dest.subtitle}</p>
                  <a
