      ...
      <div className="mx-auto w-full max-w-screen-2xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {featureKeys.map(({ title, desc, icon: Icon }) => (
            <div
              key={title}
              className="flex items-start gap-2.5 sm:gap-3 p-3 sm:p-4 rounded-xl bg-gray-50/80 hover:bg-primary/5 transition-colors"
            >
              ...
              <div className="min-w-0">
                <h3 className="text-xs sm:text-sm font-semibold text-gray-900">{t(title)}</h3>
